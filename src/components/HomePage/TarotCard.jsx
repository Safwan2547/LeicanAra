...
const TarotCard = ({ src, header, text,ParallaxStr }) => {
 ...
 >
                ...
                <motion.div initial={{y:"100%",scale:0}} animate={controls} variants={cardVarient} className='transition-all duration-[750ms] overflow-clip clickC  absolute  tarot-back  z-[2] '>
