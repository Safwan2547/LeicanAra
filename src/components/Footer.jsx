...
function Footer() {
  ...
  return (
    <div className=' '>
      <div className='relative text-NightFall bg-white'>
        <div className='flex w-full  justify-center'>
        <h1 className=' font-satoshi-light pt-10 opacity-50 text-xl'>Words that define us</h1>
        </div>
      ...
      <div className="container mx-auto flex justify-center items-center">
        ...
        {/* Footer icons */}
        <div className="  w-1/3 flex justify-center absolute left-2/3 flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-12">
